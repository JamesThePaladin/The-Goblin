...
- *Still open:* `start_room` (deferred with world_state); exact water-exclusion boundary for movement; how faithful the wall-flow can be (code-dependent); confirm co-op selectability of the custom slugcat.
